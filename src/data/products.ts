...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 34.99,
    oldPrice: 49.99,
    image: 'https://images.unsplash.com/photo-1549207107-2704df6b92ab?q=80&w=1374&auto=format&fit=crop',
    category: 'Освещение',
    inStock: false,
    rating: 4.5,
    reviews: 210,
    compatibility: ['Ford F-150 2015-2022', 'Chevrolet Silverado 2014-2021'],
    deliveryTime: 'Под заказ (5-7 дней)'
  },
  {
    id: 'p4',
    ...
    sku: 'LM-5W30-5Q',
    price: 28.99,
    image: 'https://images.unsplash.com/photo-1746014995569-135a4ea1d510?q=80&w=1931&auto=format&fit=crop',
    category: 'Жидкости',
    inStock: true,
    rating: 4.9,
    reviews: 450,
  ...
  },
  {
    ...
    sku: 'RS-SA-F1',
    price: 89.50,
    image: 'https://images.unsplash.com/photo-1769218401073-71a5b1020c9b?q=80&w=1398&auto=format&fit=crop',
    category: 'Подвеска',
    inStock: true,
    rating: 4.6,
    reviews: 42,
